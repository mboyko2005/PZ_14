...
namespace PZ_14_2_
{
	class CsvAdapter : IEmployeeDataAdapter
	{
		public List<Employee> LoadData(string filePath)
		{
			...
			Console.WriteLine($"Загрузка данных из CSV файла: {filePath}");
			...
			Console.WriteLine($"Всего загружено {employees.Count} сотрудников из CSV файла.\n");
			return employees;
		}
	}
}
